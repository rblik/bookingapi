...
public class AdminBookingControllerTest extends BaseControllerTest {
    ...
    public void testGetByRestaurantsName() {
        ResponseEntity<Booking[]> bookingsEntity = restTemplate.exchange("/admin/restaurants/the_table/bookings?date=2016-12-08", GET, new HttpEntity<String>(setBasicAuth("admin@gmail.com", "admin")), Booking[].class, emptyMap());
    ...
    public void testGetByRestaurantsNameForbidden() {
        ResponseEntity<Void> bookingsEntity = restTemplate.exchange("/admin/restaurants/the_table/bookings?date=2016-12-08", GET, new HttpEntity<String>(setBasicAuth("user@yandex.ru", "password")), Void.class, emptyMap());
