...
public class UsersUtil {
    ...
    public static final User USER_3 = new User("user@ofice.com", "NewUser", "password");

    public static final List<User> USERS = of(ADMIN_1, ADMIN_2, USER_1, USER_2);
    public static final List<User> USERS_WITH_NEW = of(ADMIN_1, ADMIN_2, USER_1, USER_2, USER_3);
}
