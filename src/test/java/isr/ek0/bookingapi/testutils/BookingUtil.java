...
public class BookingUtil {
    public static final Booking BOOKING_1 = new Booking(USER_1.getEmail(), LocalDate.of(2016, 12, 8), LocalTime.of(18, 0), RestaurantUtil.ADMIN1_RESTAURANT1.getName());
    public static final Booking BOOKING_2 = new Booking(USER_2.getEmail(), LocalDate.of(2016, 12, 8), LocalTime.of(20, 0), RestaurantUtil.ADMIN1_RESTAURANT1.getName());
    public static final List<Booking> BOOKINGS = of(BOOKING_1, BOOKING_2);
    public static final Booking NEW_BOOKING = new Booking(LocalDate.of(2016, 12, 8).plusDays(1), LocalTime.of(21, 0), RestaurantUtil.ADMIN1_RESTAURANT1.getName());
    public static final Booking NEW_BOOKING_SAVED = new Booking(USER_1.getEmail(), LocalDate.of(2016, 12, 8).plusDays(1), LocalTime.of(21, 0), RestaurantUtil.ADMIN1_RESTAURANT1.getName());
