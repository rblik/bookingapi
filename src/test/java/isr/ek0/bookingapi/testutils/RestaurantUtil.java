...
public class RestaurantUtil {
    ...
    public static final Restaurant ADMIN1_RESTAURANT1 = new Restaurant("The Table", new GeoJsonPoint(-40.0, -35.0), A_1_R_1_MEALS, ADMIN_1.getEmail(), LocalTime.of(8, 0), LocalTime.of(23, 0));
    ...
    public static final Restaurant NEW_RESTAURANT = new Restaurant("Fine Eat", new GeoJsonPoint(10, -40), NEW_RESTAURANT_MEALS, LocalTime.of(6, 0), LocalTime.of(20, 0));
    public static final Restaurant NEW_RESTAURANT_SAVED = new Restaurant("Fine Eat", null, null, ADMIN_1.getEmail(), LocalTime.of(8, 0), LocalTime.of(23, 0));
    public static final Restaurant NEW_RESTAURANT_DUBLICATE = new Restaurant("Aizle", null, null, ADMIN_1.getEmail(), LocalTime.of(7, 0), LocalTime.of(22, 0));
